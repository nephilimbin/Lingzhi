...
class AuthCodeGenerator:
    ...
    def remove_code(self, code: str) -> bool:
        ...
        """
        logger.bind(tag=TAG).info("remove_code", code)
        with self._lock:
    ...
    def _clean_expired_codes(self):
        ...
        expired_codes = [code for code, timestamp in self._code_timestamps.items() if (current_time - timestamp) > self._code_timeout]
